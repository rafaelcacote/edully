...
class StoreEventoFinanceiroRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'publicar_agora' => ['nullable', 'boolean'],
        ];
    }
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'publicar_agora' => filter_var($this->input('publicar_agora'), FILTER_VALIDATE_BOOLEAN),
